...
import { Button, ScrollView, SectionList, StyleSheet, Text, TextInput, View } from 'react-native';
...
export default function AddItems ({navigation}: AddItemsScreenProps) {
    ...
    return(
        ...
        <View style={styles.label}>
            <Button title='Clear Items' onPress={handleClear}/>
        </View>

        <View style={styles.label}> 
            <Button title='Back button' onPress={() => navigation.navigate("Home")}/>
        </View>
        </ScrollView>
    );
